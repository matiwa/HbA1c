...
public class UpdateOneTest extends AppCompatActivity {
    private Spinner sy,sm,sd;
    private EditText etid,ett;
    private ImageButton imgbtnupdate,imgbtnback;
    private TextView tv;
    DatabaseManager dm;
    Cursor k;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update_one_test);
    ...
    private void initializecomponents(){
        ...
        imgbtnupdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(etid.getText().toString().length()>0 && ett.getText().toString().length()>0) {
                    ...
                    dm.updateTest(Integer.parseInt(etid.getText().toString()),date,ett.getText().toString(),
                            String.format("%.1f", Double.parseDouble(ett.getText().toString()) * 0.0555));
                    finish();
